        ...
        try {
            ...
            return [
                ...
                'apply_summary' => [
                    ...
                    'pending_count_before' => (int) ($summary['pending_count_before'] ?? 0),
                    'orphaned_count' => (int) ($summary['orphaned_count'] ?? 0),
                    'applied' => $this->compactMigrations((array) ($summary['applied'] ?? [])),
                ],
                'report_before' => $before,
                'report_after' => $after,
            ];
