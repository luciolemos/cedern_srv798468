...
class AdminLibraryCategoryListPageAction extends AbstractAdminLibraryAction
{
    public const FLASH_KEY = 'admin_library_category_list';
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        try {
            ...
            $this->logger->warning('Falha ao listar categorias da biblioteca no admin.', [
        ...
        $basePath = '/painel/biblioteca/categorias';
        $baseQuery = [
        ...
        return $this->renderPage($response, 'pages/admin-library-categories.twig', [
            'library_categories' => $categories,
            'admin_status' => $status,
            'library_categories_sort_links' => $sortLinks,
            'library_categories_search' => $searchTerm,
            'library_categories_pagination' => [
